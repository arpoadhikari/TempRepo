...
public class SessionGenerator {
	...
	private void initialize() {
		...
		//PopUp menu for theme ->
		JPopupMenu popupMenuTheme = new JPopupMenu();
		popupMenuTheme.setBorder(new BevelBorder(BevelBorder.RAISED, null, null, null, null));
		popupMenuTheme.setFont(new Font("Segoe UI", Font.PLAIN, 14));
		addPopup(frmSessionGenerator.getContentPane(), popupMenuTheme);
		
		JMenu mnThemes = new JMenu("Set Theme");
		mnThemes.setIcon(new ImageIcon(SessionGenerator.class.getResource("/icons/SetTheme.png")));
		mnThemes.setBorder(new BevelBorder(BevelBorder.RAISED, null, null, null, null));
		mnThemes.setFont(new Font("Segoe UI", Font.PLAIN, 14));
		popupMenuTheme.add(mnThemes);
		
		JMenuItem mntmNimbus = new JMenuItem("Nimbus	");
		mntmNimbus.setFont(new Font("Segoe UI", Font.PLAIN, 14));
		mntmNimbus.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				try {
					...
					System.out.println("Error occurred while applying the theme:"+e1.getMessage());
				}
				SwingUtilities.updateComponentTreeUI(frmSessionGenerator);
				table.setShowHorizontalLines(true);
				table.setShowVerticalLines(true);
			}
		});
		mnThemes.add(mntmNimbus);
		
		JMenuItem mntmMetal = new JMenuItem("Metal");
		mntmMetal.setFont(new Font("Segoe UI", Font.PLAIN, 14));
		mntmMetal.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				try {
					UIManager.setLookAndFeel(lookNfeel_Metal);
				} catch (ClassNotFoundException | InstantiationException | IllegalAccessException
						| UnsupportedLookAndFeelException e1) {
					System.out.println("Error occurred while applying the theme:"+e1.getMessage());
				}
		...
		mnThemes.add(mntmMetal);
		
		JMenuItem mntmMotif = new JMenuItem("Motif");
		mntmMotif.setFont(new Font("Segoe UI", Font.PLAIN, 14));
		mntmMotif.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				try {
					UIManager.setLookAndFeel(lookNfeel_Motif);
				} catch (ClassNotFoundException | InstantiationException | IllegalAccessException
						| UnsupportedLookAndFeelException e1) {
					System.out.println("Error occurred while applying the theme:"+e1.getMessage());
				}
		...
		mnThemes.add(mntmMotif);
		//<-----
		
		//Label for Browser Type Combo Box ->
		JLabel lblChooseABrowser = new JLabel("Choose a Browser :");
		lblChooseABrowser.setFont(new Font("Segoe UI", Font.PLAIN, 14));
		lblChooseABrowser.setBounds(30, 15, 130, 32);
		...
		comboBox.setBounds(160, 15, 153, 32);
		...
		chckbxAddFirebug.setFont(new Font("Segoe UI", Font.PLAIN, 14));
		chckbxAddFirebug.setBounds(342, 20, 178, 23);
		...
		chckbxForServer.setFont(new Font("Segoe UI", Font.PLAIN, 14));
		chckbxForServer.setBounds(30, 207, 172, 23);
		...
		lblPort.setBounds(216, 207, 38, 23);
		...
		textField.setBounds(256, 205, 73, 28);
		...
		chckbxEnablePassthrough.setFont(new Font("Segoe UI", Font.PLAIN, 14));
		...
		popupMenu_AddRemoveRow.setFont(new Font("Segoe UI", Font.PLAIN, 14));
		...
		mntmAddRow.setFont(new Font("Segoe UI", Font.PLAIN, 14));
		...
		mntmRemoveRow.setFont(new Font("Segoe UI", Font.PLAIN, 14));
		...
		popupMenu_AddRow.setFont(new Font("Segoe UI", Font.PLAIN, 14));
		...
		scrollPane_textArea.setBounds(12, 240, 520, 320);
		...
		popupMenu_CopyClearText.setFont(new Font("Segoe UI", Font.PLAIN, 14));
		...
		mntmCopyText.setFont(new Font("Segoe UI", Font.PLAIN, 14));
		...
		mntmClearLogs.setFont(new Font("Segoe UI", Font.PLAIN, 14));
		...
		//UI Inspector Button ->
		btnLaunchInspector = new JButton("Object Spy");
	...
	private void setServerConfiguration() throws Exception {
		...
		config.enablePassThrough = chckbxEnablePassthrough.isSelected();
		config.debug = true;
